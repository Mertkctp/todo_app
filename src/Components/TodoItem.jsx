const TodoItem = ({ todo, toggleComplete, deleteTodo, startEdit, isDarkMode }) => {
  ...
  return (
    <div className={`group flex items-center justify-between p-4 rounded-xl mb-2 transition-all border ${isDarkMode ? 'bg-gray-800/50 border-gray-700 hover:border-indigo-500' : 'bg-white border-gray-100 shadow-sm hover:border-indigo-300'}`}>
      ...
      <div className="flex gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
        <button onClick={() => startEdit(todo)} className="p-1.5 text-indigo-400 hover:bg-indigo-50 rounded-lg transition-colors">
